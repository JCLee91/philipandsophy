import { format, subDays, parseISO, isValid, isFuture, addDays, isAfter } from 'date-fns';
import { toZonedTime } from 'date-fns-tz';
import type { Timestamp } from 'firebase-admin/firestore';

// Firebase Functions 환경에서는 console 직접 사용 (logger 제거)

// Cohort 타입 정의 (Firebase Functions 환경)
...
/**
 * 전체 프로필을 공개할 수 있는 날인지 체크 (새벽 2시 마감 정책 적용)
 * (마지막 날부터 무제한)
 *
 * @param cohort - 기수 정보
...
/**
 * 인증 없이도 전체 프로필을 볼 수 있는 날인지 체크 (새벽 2시 마감 정책 적용)
