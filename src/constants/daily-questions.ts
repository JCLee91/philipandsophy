...
const DAILY_QUESTIONS_SCHEDULE: DailyQuestion[] = [
  ...
  // Day 5 (10월 15일)
  { category: '꿈꾸는 미래', question: '시간이 지나도 변하지 않거를 바라는 나의 모습은 무엇인가요?' },
  // Day 6 (10월 16일)
  { category: '생활 패턴', question: '일상에서 가장 중요하거나 물입없는 습관은 무엇인가요?' },
  // Day 7 (10월 17일)
  { category: '연애 스타일', question: '연애상대방이 내게 대해 꼭 알아야 할 한가지가 있다면?' },
  // Day 8 (10월 18일)
  ...
  // Day 11 (10월 21일)
  { category: '꿈꾸는 미래', question: '책이나 영화를 보면서 삶이 보고 싶은 삶이 있었나요?' },
  // Day 12 (10월 22일)
  { category: '성향', question: '나만의 인간관계 순정 포인트를 알려주세요.' },
  // Day 13 (10월 23일)
  { category: '생활 패턴', question: '남들이 안 해봤을 법한, 나만의 특별한 경험이 있다면?' },
  // Day 14 (10월 24일)
  { category: '가치관 & 삶', question: '차 한 대, 소과 하나, 신발 한 켤레에 쓸 수 있는 최대 금액은?' },
];
