        ...
        <LandingLayout>
            ...
            <div className="party-page-container">
                <div className="party-image-wrapper">
                    ...
                    {/* 신청하기 버튼 오버레이 */}
                    <div className="absolute left-0 right-0 top-[23.5%] z-10 flex flex-col items-center justify-center gap-3 px-5">
                        <a
                            href="https://smore.im/form/ghjIyG9Bv8"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="group relative flex h-[72px] w-full max-w-[380px] items-center justify-center overflow-hidden rounded-[20px] border border-white/20 bg-gradient-to-br from-gray-800/90 to-black/95 px-8 text-[20px] font-semibold text-white shadow-[0_12px_32px_rgba(0,0,0,0.3),inset_0_1px_0_rgba(255,255,255,0.15)] backdrop-blur-xl transition-all duration-[400ms] ease-[cubic-bezier(0.23,1,0.32,1)] hover:-translate-y-[3px] hover:scale-[1.02] hover:bg-gradient-to-br hover:from-gray-700/90 hover:to-black hover:shadow-[0_16px_48px_rgba(0,0,0,0.4),inset_0_1px_0_rgba(255,255,255,0.15)] active:scale-[0.98] active:-translate-y-[1px] active:duration-100 before:absolute before:left-[-100%] before:top-0 before:z-[1] before:h-full before:w-full before:bg-gradient-to-r before:from-transparent before:via-white/20 before:to-transparent before:transition-all before:duration-1000 before:ease-out hover:before:left-[100%]"
                            aria-label="12월 멤버스 파티 신청하기"
                        >
                            <span className="relative z-10 [text-shadow:0_1px_2px_rgba(0,0,0,0.2)]">12월 멤버스 파티 신청하기</span>
                        </a>
                    </div>
                </div>
