        ...
        headers: [
          {
            ...
            value: `
              ...
              style-src 'self' 'unsafe-inline' https://cdn.jsdelivr.net https://tagmanager.google.com https://fonts.googleapis.com https://fonts.cdnfonts.com;
              img-src 'self' data: blob: https: http: https://*.googletagmanager.com https://*.google-analytics.com https://*.analytics.google.com https://www.googletagmanager.com https://www.google-analytics.com;
              font-src 'self' data: https://cdn.jsdelivr.net https://fonts.gstatic.com https://fonts.cdnfonts.com;
              connect-src 'self' https://*.firebaseapp.com https://*.firebaseio.com https://*.googleapis.com https://identitytoolkit.googleapis.com https://securetoken.googleapis.com https://*.cloudfunctions.net wss://*.firebaseio.com https://openapi.naver.com https://*.run.app https://www.google.com https://recaptchaenterprise.googleapis.com https://www.google-analytics.com https://ssl.google-analytics.com https://analytics.google.com https://stats.g.doubleclick.net https://www.facebook.com https://*.facebook.com https://*.facebook.net https://contents.kyobobook.co.kr https://hook.us2.make.com https://*.googletagmanager.com https://*.google-analytics.com https://*.analytics.google.com ${GSTATIC_ENDPOINT} ${CDN_JSDELIVR_ENDPOINT} ${META_CAPI_ENDPOINT};
